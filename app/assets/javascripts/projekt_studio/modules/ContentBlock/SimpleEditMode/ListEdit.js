  ...
  addItemControlls(li) {
    ...
    if (!ProjektStudio.ContentBlock.DomHelpers.isSliderItem(li)) {
      const dragHandleHTML = `
        <button
          class="content-block--item-drag-handle ${baseClass} ${this.listControlClass} js-list-item-dnd-handle js-content-block-element-not-editable -drag"
    ...
    const deleteButtonHtml = `
        <button
          class="content-block--item-delete-button ${baseClass} ${this.listControlClass} js-projekt-content-block--delete-item js-content-block-element-not-editable -delete"
          contenteditable="false"
        >
