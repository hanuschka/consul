...
// embed via App.ContentBlockEditor.MapEmbed, so the preview shows the exact
// markup the server renders on the published page. The panel itself must never
// reach the saved body: ProjektStudio.utils.resetMapEmbeds strips
// .js-map-source-control while keeping the wrapper and its data attributes.
App.ContentBlockEditor.SimpleEditMode.MapSourceEdit = {
  ...
  handleResourceChange(e) {
    ...
    App.ContentBlockEditor.MapEmbed.rehydrate(embed);
  },
