class Kern::RegisteredAddressSelectorComponent < ApplicationComponent
  def initialize(resource: nil, selected_city_id: nil, selected_street_id: nil, selected_address_id: nil, labels: false)
    @resource = resource
