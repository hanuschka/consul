class Adm::DeficiencyReports::MilestonesController < Adm::DeficiencyReports::BaseController
  ...
  private
    ...
    def milestoneable_path
      polymorphic_path([:adm_deficiency_reports, @milestone.milestoneable], action: :edit)
    end
end
