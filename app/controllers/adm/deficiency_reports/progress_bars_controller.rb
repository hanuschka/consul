class Adm::DeficiencyReports::ProgressBarsController < Adm::DeficiencyReports::BaseController
  ...
  private
    ...
    def progress_bars_index
      polymorphic_path([:adm_deficiency_reports, @progressable], action: :edit)
    end
end
