class Admin::ProjektsController < Admin::BaseController
  ...
  def projekt_params
    attributes = [
      ...
      comment_phase_attributes: [:id, :start_date, :end_date, :geozone_restricted, :active, :info_active, geozone_restriction_ids: [], bam_street_ids: [] ],
      debate_phase_attributes: [:id, :start_date, :end_date, :geozone_restricted, :active, :info_active, geozone_restriction_ids: [], bam_street_ids: [] ],
