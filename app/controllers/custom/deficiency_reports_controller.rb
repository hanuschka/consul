class DeficiencyReportsController < ApplicationController
  ...
  def json_data
    ...
    data = {
      ...
      image_url: image_url,
      image_ai_label: helpers.ai_image_label_payload(@deficiency_report.image),
  ...
  def notify_responsible(dr)
    if dr.responsible.is_a?(DeficiencyReport::OfficerGroup) && dr.responsible.default_email.present?
