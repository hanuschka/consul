module Verification
  ...
  included do
    ...
    scope :level_two_verified, -> { where("users.level_two_verified_at IS NOT NULL OR users.confirmed_phone IS NOT NULL AND verified_at IS NULL") }
    ...
    scope :level_two_or_three_verified, -> { where("users.verified_at IS NOT NULL OR users.level_two_verified_at IS NOT NULL OR users.confirmed_phone IS NOT NULL") }
