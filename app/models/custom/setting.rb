    ...
    def defaults
      {
        ...
        "extended_feature.verification.manual_verifications": false,

        "extra_fields.registration.first_name": true,
        "extra_fields.registration.last_name": true,
        "extra_fields.registration.street_name": true,
        "extra_fields.registration.street_number": true,
        "extra_fields.registration.plz": true,
        "extra_fields.registration.city_name": true,
        "extra_fields.registration.date_of_birth": true,
        "extra_fields.registration.gender": true,
