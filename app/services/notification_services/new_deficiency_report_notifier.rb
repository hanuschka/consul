  ...
  class NewDeficiencyReportNotifier < ApplicationService
    ...
    private
      ...
      def users_to_notify_ids
        ...
        deficiency_report_administrator_ids = User.joins(:deficiency_report_manager).ids

        [administrator_ids, moderator_ids, deficiency_report_administrator_ids].flatten.uniq
      end
  end
end
