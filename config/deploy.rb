...
def deploysecret(key)
  @deploy_secrets_yml ||= YAML.load_file("config/deploy-secrets/deploy-secrets-cli_kir.yml")[fetch(:stage).to_s]
...
namespace :deploy do
  ...
  before "deploy:restart", "custom_deploy:launch_delay_job"
