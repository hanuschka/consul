class InvertOnlyAdminsCreateProposals < ActiveRecord::Migration[6.1]
  def up
    ProjektPhase::ProposalPhase.find_each do |phase|
      ...
      phase.settings.find_or_create_by!(key: "feature.general.users_can_create_proposals") do |setting|
  ...
  def down
    ProjektPhase::ProposalPhase.find_each do |phase|
      new_setting = phase.settings.find_by(key: "feature.general.users_can_create_proposals")
