...
load Rails.root.join("db", "pages", "impressum.rb")
load Rails.root.join("db", "pages", "contact_us.rb")
load Rails.root.join("db", "pages", "census_terms.rb")
load Rails.root.join("db", "pages", "netiquette.rb")
load Rails.root.join("db", "pages", "additional_privacy.rb")
load Rails.root.join("db", "pages", "open_source.rb")
