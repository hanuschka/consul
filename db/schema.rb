...
ActiveRecord::Schema.define(version: 2025_03_27_161057) do
  ...
  create_table "api_clients", force: :cascade do |t|
    ...
    t.string "consul_auth_token"
    t.string "domain"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "service_auth_token"
    t.index ["service_auth_token"], name: "index_api_clients_on_service_auth_token"
  end
