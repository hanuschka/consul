class RemoteCensusApi
  ...
  class Response
    ...
    def last_name_matched?
      @body.xpath("//ns2:ergebnis/ns2:ergebnis //ns2:familienname/ns2:nachname", "ns2" => "http://www.osci.de/xmeld34").text ==
        @body.xpath("//ns2:datenZurAnfrage //ns2:nachname/name", "ns2" => "http://www.osci.de/xmeld34").text
    end
  ...
  private
    ...
    def get_response_body(first_name:, last_name:, street_name:, street_number:, plz:, city_name:, date_of_birth:, gender:)
      ...
      https = Net::HTTP.new(url.host, url.port, Rails.application.secrets.proxy_ip, Rails.application.secrets.proxy_port)
      https.use_ssl = true
