...
class Ai::GenerateProposalsAndCommentsForAiStats
  ...
  def call
    ...
    total_sentiments = @proposals.count { |p| p.sentiment_id.present? }
...
if __FILE__ == $0
  ...
  Ai::GenerateProposalsAndCommentsForAiStats.call(projekt_phase_id)
end
