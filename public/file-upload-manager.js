            ...
            if (chosenItem.data_content_type.startsWith('image/')) {
              ...
              if (selectedElement && ['imageBlock', 'imageInline'].includes(selectedElement.name)) {
                ...
                if (canInsertImageBlock) {
                  var imageBlockElement = writer.createElement('imageBlock', imageAttributes);
                  ...
                  var imageInlineElement = writer.createElement('imageInline', imageAttributes);
                  ...
                  var fallbackImageBlockElement = writer.createElement('imageBlock', imageAttributes);
