                    ...
                    if (chosenItem.data_content_type.startsWith('image/')) {
                        ...
                        if (selectedElement && ['imageBlock', 'imageInline'].includes(selectedElement.name)) {
                            ...
                            if (canInsertImageBlock) {
                                const imageBlockElement = writer.createElement('imageBlock', imageAttributes);
                                ...
                                const imageInlineElement = writer.createElement('imageInline', imageAttributes);
                                ...
                                const fallbackImageBlockElement = writer.createElement('imageBlock', imageAttributes);
    ...
    _fetchFiles(params) {
        ...
        fetch(this.apiGet, {
            ...
            .then((data) => {
                ...
                /*const dialogElement = document.querySelector('.ck-dialog');
                if (dialogElement) {
                    dialogElement.style.top = '150px';
                }*/
            })
            .catch((error) => {
                alert(error.message);
