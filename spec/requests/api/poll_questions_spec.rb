...
RSpec.describe 'Poll Questions API', type: :request, openapi_spec: 'v1/swagger.yaml' do
  ...
  path '/api/polls/{poll_id}/questions' do
    ...
    get 'List questions for a poll' do
      ...
      description "List all questions within a specific poll. Returns questions with their answers. #{ApiAccessRequirements::GET_READ_ONLY}"
      ...
      response '200', 'questions found' do
        ...
        before do
          ...
          poll.questions.create!(title: 'Question 1', author: author)
          poll.questions.create!(title: 'Question 2', author: author)
        end
    ...
    post 'Create a poll question' do
      ...
      parameter name: :question, in: :body, description: 'Poll question creation payload', schema: Schemas::Polls::POLL_QUESTION_CREATE_PARAMS
  ...
  path '/api/poll_questions/{id}' do
    ...
    patch 'Update a poll question' do
      ...
      parameter name: :question, in: :body, description: 'Attributes to update on the poll question', schema: Schemas::Polls::POLL_QUESTION_UPDATE_PARAMS
      ...
      response '200', 'question updated' do
        ...
        let(:poll_question) { poll.questions.create!(title: 'Original Title', author: author) }
        let(:id) { poll_question.id }
        let(:question) do
          {
            question: {
    ...
    delete 'Delete a poll question' do
      ...
      response '200', 'question deleted' do
        ...
        let(:poll_question) { poll.questions.create!(title: 'To Delete', author: author) }
        let(:id) { poll_question.id }
